...
Route::post('raw_products', [MdProductController::class, 'get_all_prod'])->name('product_raw');
...
Route::post('product_edit/{id}', [MdProductController::class, 'edit'])->name('product_edit');
